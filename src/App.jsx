...
<a
  href="https://wa.me/919894349627?text=Hello%20Bharath%20Dental%20Lab,%20I%20would%20like%20to%20know%20more%20about%20your%20services."
  className="whatsappButton"
  target="_blank"
  rel="noopener noreferrer"
  aria-label="Chat with Bharath Dental Lab on WhatsApp"
>
        <svg
          viewBox="0 0 32 32"
        ...
        >
          <path
            d="M19.11 17.21c-.27-.14-1.6-.79-1.85-.88-.25-.09-.43-.14-.61.14-.18.27-.7.88-.86 1.06-.16.18-.32.2-.59.07-.27-.14-1.13-.42-2.15-1.33-.79-.7-1.33-1.56-1.49-1.83-.16-.27-.02-.42.12-.56.12-.12.27-.32.41-.48.14-.16.18-.27.27-.45.09-.18.05-.34-.02-.48-.07-.14-.61-1.47-.84-2.02-.22-.53-.45-.46-.61-.47h-.52c-.18 0-.48.07-.73.34-.25.27-.95.93-.95 2.27s.98 2.64 1.11 2.82c.14.18 1.93 2.95 4.68 4.14.65.28 1.16.45 1.56.57.66.21 1.26.18 1.73.11.53-.08 1.6-.65 1.83-1.28.23-.63.23-1.17.16-1.28-.07-.11-.25-.18-.52-.32z"
          />

          <path
            d="M16 3C8.83 3 3 8.83 3 16c0 2.29.6 4.44 1.65 6.31L3 29l6.88-1.61A12.94 12.94 0 0 0 16 29c7.17 0 13-5.83 13-13S23.17 3 16 3zm0 23.77c-2.03 0-3.92-.61-5.5-1.65l-.39-.25-4.08.96.98-3.98-.26-.41A10.76 10.76 0 1 1 16 26.77z"
          />
        </svg>
      </a>
